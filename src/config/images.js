...
const catalog = {
  ...
  leadershipCardFounder: [`${V}/leadership/vetham-card-founder-pro-name.png`],
  leadershipCardPresident: [`${V}/leadership/vetham-card-president-pro-name.png`],
  leadershipCardSecretary: [`${V}/leadership/vetham-card-secretary-pro-name.png`],
  leadershipCardTreasurer: [`${V}/leadership/vetham-card-treasurer-pro-name.png`],

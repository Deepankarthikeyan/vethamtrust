...
const catalog = {
  ...
  trustee2: [`${V}/trustee-selvin.png`],
  trustee3: [`${V}/trustee-balasubramanian.png`],
  trustee4: [`${V}/trustee-sureash.jpg`],
  portraitFounder: [`${V}/trustee-gnana-rishi.jpg`],
  portraitPresident: [`${V}/trustee-selvin.png`],
  portraitSecretary: [`${V}/trustee-balasubramanian.png`],
  portraitTreasurer: [`${V}/trustee-sureash.jpg`],
  blog1: [`${V}/blog-1.jpg`],
  blog2: [`${V}/blog-2.jpg`],
  blog3: [`${V}/blog-3.jpg`],
  blog4: [`${V}/blog-4.jpg`],

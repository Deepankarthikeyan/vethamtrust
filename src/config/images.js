...
const catalog = {
  ...
  portraitFounder: [`${V}/leadership/portraits/portrait-founder-suit-tall.png`],
  portraitPresident: [`${V}/leadership/portraits/portrait-president-suit-tall.png`],
  portraitSecretary: [`${V}/leadership/portraits/portrait-secretary-suit-tall.png`],
  portraitTreasurer: [`${V}/leadership/portraits/portrait-treasurer-suit-tall.png`],
  blog1: [`${V}/blog-1.jpg`],
  blog2: [`${V}/blog-2.jpg`],
  blog3: [`${V}/blog-3.jpg`],
  blog4: [`${V}/blog-4.jpg`],

export const HOME_BLOG_POSTS = [
  {
    ...
    text: 'Exploring the most unusual spiritual practices. Spirituality takes many forms, and some paths lead to profound inner discovery.',
  },
  {
    image: 'blog2',
    title: 'The conscious creation of reality',
    text: 'Meditation: The conscious creation of reality. In today\'s fast-paced world, meditation helps shape a peaceful inner life.',
  },
  {
    image: 'blog3',
    title: 'Yoga can actually make you happier',
    text: 'Yoga can actually make you happier. In a world full of stress and distractions, yoga offers a natural path to joy.',
  },
];
